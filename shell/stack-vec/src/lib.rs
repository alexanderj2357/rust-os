...
// Implemention of `Deref` trait for `StackVec`
...
// Implemention of `DerefMut` trait for `StackVec`
...
// Implemention of `IntoIterator` trait for `StackVec`.
...
// Implementation of `IntoIterator` trait for `&StackVec`.
